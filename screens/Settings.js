...
import { TextInput, ScrollView, Image, StyleSheet, TouchableOpacity } from 'react-native';

import Slider from 'react-native-slider'

import { Block, Button, Text, Input, Divider, Switch } from "../components";
        ...
        <ScrollView showVerticalScrollIndicator={false}>
          ...
          <Block style={styles.toggles}>
            ...
            <Block row center space='between' style={{ marginBottom: theme.sizes.base * 2 }}>
              ...
              <Switch
                value={this.state.newsletters}
                onValueChange={value => this.setState({ newsletters: value })}
              // onValueChange={value => console.log('value:', value)}
              />
            </Block>
          </Block>
